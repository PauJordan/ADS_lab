...
#set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports {C_D[6]}]
#set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {C_D[4]}]
#set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports {C_D[2]}]
#set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports {C_D[1]}]
##set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { JA[7] }]; #IO_L16N_T2_A27_15 Sch=ja[7]
#set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports C_PWDN]
#set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports C_VS]
#set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports C_HR]


##Pmod Header JB

#set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports {C_D[0]}]
#set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports {C_D[3]}]
#set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {C_D[5]}]
