...
HD_PWD='C:/Users/Pau/Documents/Repositoris/test_sim/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log o_generic_sr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source o_generic_sr.tcl
